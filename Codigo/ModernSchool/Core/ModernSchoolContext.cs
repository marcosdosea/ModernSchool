        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Alunoturma>(entity =>
            {
                ...
                entity.Property(e => e.Status)
                    .IsRequired()
                    .HasColumnType("enum('M','A','R','C')")
                    .HasColumnName("status")
                    .HasDefaultValueSql("'M'")
                    .HasComment("M - MATRICULADO\nA - APROVADO\nR - REPROVADO\nC - CANCELADO");
            ...
            modelBuilder.Entity<Comunicacao>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdPessoaRemetente, "fk_Comunicacao_Pessoa1_idx");
                ...
                entity.Property(e => e.IdPessoaRemetente)
                    .HasColumnType("int unsigned")
                    .HasColumnName("idPessoaRemetente");
                ...
                entity.HasOne(d => d.IdPessoaRemetenteNavigation)
                    .WithMany(p => p.Comunicacaos)
                    .HasForeignKey(d => d.IdPessoaRemetente)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_Comunicacao_Pessoa1");
            ...
            modelBuilder.Entity<Curriculo>(entity =>
            {
                ...
                entity.Property(e => e.IdGoverno)
                    .HasColumnType("int unsigned")
                    .HasColumnName("idGoverno");
            ...
            modelBuilder.Entity<Escola>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdDiretor, "fk_Escola_Pessoa1_idx");
            ...
            modelBuilder.Entity<Governoservidor>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdEscola, "fk_GovernoServidor_Escola1_idx");
                ...
                entity.HasOne(d => d.IdEscolaNavigation)
                    .WithMany(p => p.Governoservidors)
                    .HasForeignKey(d => d.IdEscola)
                    .HasConstraintName("fk_GovernoServidor_Escola1");
